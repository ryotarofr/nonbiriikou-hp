  ...
  return (
    <div className="items-center px-6 pb-6 overflow-hidden ">
      <div className="mx-auto">
        ...
        {dropdown === 1 &&
          <div className=' p-3'>
            仕事(作業)や活動、イベント、日常のコミュニケーションなどをと通して『自分らしさ』を発見していただき、自分の夢や目標に希望が持てるように！そして、そのきっかけづくりが “のんびりいこう” でできるといいなと思っています！他の人と比較することなく、自分のペースで “のんびり” と・・・。素敵な自分発見を我々と一緒に楽しみましょう！！
          </div>
        }
        {dropdown === 2 &&

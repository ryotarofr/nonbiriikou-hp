    ...
    <Card className="items-center p-3 overflow-hidden">
      <Tabs defaultValue="heart" className="mx-auto">
        ...
        <TabsContent value="heart" className=' p-3'>
          ...
          であるならば、自分たちが考えを具体化できるような、どこにもない『心ある楽しい福祉サービス』を追求し、サービスを受けていただく利用者様(ご家族)、サービスを提供する職員、共に楽しく成長し幸せになれるような会社にしたいと心から思います。
        </TabsContent>
        <TabsContent value="message" className=' p-3'>
          仕事(作業)や活動、イベント、日常のコミュニケーションなどをと通して『自分らしさ』を発見していただき、自分の夢や目標に希望が持てるように・・・！そして、そのきっかけづくりが&quot;のんびりいこう&quot;でできるといいな・・・と思っています！他の人と比較することなく、自分のペースで&quot;のんびり&quot;と・・・。素敵な自分発見を我々と一緒に楽しみましょう！！
        </TabsContent>
